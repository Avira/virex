 ...
 * 
 * The statistics - chart view of the traffic
 */
Yiibase::import('application.extensions.chartjs2.Chartjs2');
$this->headlineText = "Traffic Statistics";
?>
<style type="text/css">
    div.row h4 {
        margin-bottom: 3px;
...
<div class="form" id="formDiv" style="display: inline-block;">
    <div>
        <div class="row inlinerow">
            ...
            <?php echo CHtml::activeDropDownList($form, 'type', array('filesno' => 'Files no.', 'filesize' => 'File size'), array('style' => 'width: 105px;')); ?>
        </div>
        <div class="row inlinerow">
            <h4><?php echo CHtml::activeLabel($form, 'user'); ?></h4>
            <?php echo CHtml::activeDropDownList($form, 'user', CHtml::listData(ExternalUser::model()->findAllByAttributes(array('status_usr' => '2'), array('order' => 'name_usr ASC')), 'id_usr', 'name_usr'), array('prompt' => 'all', 'style' => 'width: 105px;')); ?>
        </div>
        <div class="row inlinerow">
            <h4><?php echo CHtml::activeLabel($form, 'group'); ?></h4>
            <?php echo CHtml::activeDropDownList($form, 'group', array('hour' => 'Hour', 'day' => 'Day', 'week' => 'Week', 'month' => 'Month', 'user' => 'User'), array('style' => 'width: 105px;')); ?>
        </div>
